...
public class Main {
    public static void main(String[] args) {
        ...
        start.addTransition(new Transition(start, tapeSymbol.ZERO, q_py0, tapeSymbol.X, 1));
        start.addTransition(new Transition(start, tapeSymbol.ONE, q_py1, tapeSymbol.X, 1));
        ...
        qb.addTransition(new Transition(qb, tapeSymbol.X, qX, tapeSymbol.X, 1));

        // qX transitions
        qX.addTransition(new Transition(qX, tapeSymbol.BLANK, accept, tapeSymbol.BLANK, 0));
        qX.addTransition(new Transition(qX, tapeSymbol.ZERO, q0, tapeSymbol.X, 1));
        qX.addTransition(new Transition(qX, tapeSymbol.ONE, q1, tapeSymbol.X, 1));
        qX.addTransition(new Transition(qX, tapeSymbol.Y, qX, tapeSymbol.Y, 1));
        ...
        Tape NTMTape = new Tape(new ArrayList<>(Arrays.asList(tapeSymbol.ONE, tapeSymbol.ZERO, tapeSymbol.ONE, tapeSymbol.ZERO)));
